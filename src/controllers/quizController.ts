 ...
 *
 * IMPORTANT:
 * This endpoint is used by the creator/editor as well as participants.
 * Therefore, the creator is allowed to receive the complete quiz including
 * answer keys.
 *
 * For attempting a quiz, use GET /quizzes/:id/attempt instead.
 */
export async function getQuiz(req: Request, res: Response) {
  ...
  const isOwner =
    req.user &&
    quiz.creatorId.toString() === req.user.userId;
  ...
  // Never expose answer keys to normal participants.
